...
VALUES ('admin', 'admin', '12345678A', 'Administrador General', TO_DATE('2020-01-15', 'YYYY-MM-DD'), NULL);

INSERT INTO Trabajador (usuario, contraseña, DNI, nombre, fecha_contratacion, id_administrador)
VALUES ('trabajador01', 'pass123', '87654321B', 'Juan Pérez', TO_DATE('2021-03-10', 'YYYY-MM-DD'), 'admin01');

INSERT INTO Trabajador (usuario, contraseña, DNI, nombre, fecha_contratacion, id_administrador)
VALUES ('trabajador02', 'pass123', '11223344C', 'Lucía Gómez', TO_DATE('2022-06-20', 'YYYY-MM-DD'), 'admin01');
